        ...
        <div className='container mx-auto'>
          ...
          <div>
            <div className='grid grid-cols-2 md:grid-cols-3 gap-4 max-w-6xl mx-auto'>
             ...
             <Image src='/sponsor/GetEquityBlue.png'  className="filter grayscale brightness-50" width={200} height={44} alt='get equity' data-aos='fade-up-right' />
            </div> 

            <div className=' flex items-center justify-center border-2 border-primary bg-black h-64 w-full '>
             <Image src='/sponsor/NTIT.png' width={58} height={51} alt='NTIT' data-aos='fade-up-right' />
            </div>

            <div className=' flex items-center justify-center border-2 border-primary bg-white  h-64 w-full'>
             <Image src='/sponsor/GetEquityBlue.png'  className="filter grayscale brightness-50" width={200} height={44} alt='getequity' data-aos='fade-up-right' />
            </div>

            <div className=' flex items-center justify-center border-2 border-primary bg-black  h-64 w-full'>
             <Image src='/sponsor/NTIT.png' width={58} height={54} alt='NTIT' data-aos='fade-up-right' />
            </div>
            ...
            <div className=' flex items-center justify-center border-2 border-primary bg-black  h-64 w-full'>
             <Image src='/sponsor/GetEquitywhite.png' width={200} height={44} alt='get equity' data-aos='fade-up-right' />
            </div>
          </div>
