      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className=''>
          ...
          <div className="relative mb-8 max-w-max mx-auto">
            ...
            <h2 className='text-white font-normal md:text-5xl text-5xl text-center font-bold'>Events</h2>
          ...
          <div className='md:grid grid-cols-3 gap-4'>
            <div data-aos='fade-up' className='mb-8 text-center md:text-left'>
              ...
              <h2 className='text-white md:text-3xl text-4xl leading-10 mb-2 mt-4 font-medium'>Webinar</h2>
              <p className='text-white font-normal md:text-lg text-2xl tracking-wider'>
            ...
            <div data-aos='fade-up' className='mb-8 text-center md:text-left'>
              ...
              <h2 className='text-white md:text-3xl text-4xl leading-10 mb-2 mt-4 font-medium'>Bootcamp 1.0</h2>
              <p className='text-white font-normal md:text-lg text-2xl tracking-wider'>
            ...
            <div data-aos='fade-up' className='text-center md:text-left'>
              ...
              <h2 className='text-white md:text-3xl text-4xl leading-10 mb-2 mt-4 font-medium'>Outreach</h2>
              <p className='text-white font-normal md:text-lg text-2xl tracking-wider'>
