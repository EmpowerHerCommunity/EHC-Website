      ...
      <div className="container xl:max-w-screen-xl mx-auto px-4 py-16 ">
        <div className='our-vision md:grid grid-cols-2 gap-32' id='vision'>
          <div data-aos='zoom-in'>
            ...
            <p className='font-normal md:text-lg text-xl md:leading-8 mb-4'>
          ...
          <div data-aos='zoom-out' className='' id='mission'>
            ...
            <p className='font-normal md:text-lg text-xl md:leading-8'>To build a community that focuses on providing opportunites for women transitioning into information technology. A community where Information Technology is perceived accessible to all women regardless of their age or background.</p>
          </div>
        </div>
      </div>
    </section>
