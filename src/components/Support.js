...
const Support = () => {
  return (
    ...
    <div className="flex flex-col justify-center items-center">
      ...
      <h2 className="lg:text-xl font-bold text-lg py-3 text-center">Support Us at Empower Her Community</h2>
    ...
    <div className="border rounded-2xl mt-5 p-6 bg-supportb border-support">
    ...
    <div className="border border-support bg-supportb rounded-2xl mt-10 px-7 py-7 bg-grey">
      ...
      <p className="lg:text-lg text-base text-blogSearch">Choose Materials to donate:</p>
