						...
						<div className='flex overflow-hidden' data-aos='fade-up'>
							<div className='relative w-full shadow-2x1 overflow-hidden'>
								...
								<div className='flex justify-start bg-black bg-opacity-70 text-white text-left absolute top-0 right-0 bottom-0 left-0 p-5'>
									<div className='flex flex-col gap-4 justify-end max-w-[280px] '>
								...
								<div className='flex justify-start bg-black bg-opacity-70 text-white text-left absolute top-0 right-0 bottom-0 left-0 p-5'>
									<div className='flex flex-col gap-4 justify-end max-w-[250px] '>
										...
										<Link href='https://bit.ly/ehc_comm_manager'>
											<a target='_blank' className="inline-block bg-[#FFCF00] text-white text-base text-center leading-[1] w-44 p-4">
												Apply Here
											</a>
										</Link>
									</div>
								...
								<div className='flex justify-start bg-black bg-opacity-70 text-white text-left absolute top-0 right-0 bottom-0 left-0 p-5'>
									<div className='flex flex-col gap-4 justify-end max-w-[250px] '>
										...
										<Link href='https://forms.gle/1MveyWBQbKQKbaV36'>
											<a target='_blank' className="inline-block bg-[#3C3C3C] text-white text-base text-center leading-[1] w-44 p-4">
												Apply Here
											</a>
										</Link>
									</div>
								...
								<div className='flex justify-start bg-black bg-opacity-70 text-white text-left absolute top-0 right-0 bottom-0 left-0 p-5'>
									<div className='flex flex-col gap-4 justify-end max-w-[250px] '>
										...
										<Link href='https://forms.gle/QkiWM536MKUHKweq5'>
											<a target='_blank' className="inline-block bg-[#BA2989] text-white text-base text-center leading-[1] w-44 p-4">
												Apply Here
											</a>
										</Link>
									</div>
								...
								<div className='flex justify-start bg-black bg-opacity-70 text-white text-left absolute top-0 right-0 bottom-0 left-0 p-5'>
									<div className='flex flex-col gap-4 justify-end max-w-[250px] '>
										...
										<Link href='https://bit.ly/ehcsocialmediamanager'>
											<a target='_blank' className="inline-block bg-[#7B61FF] text-white text-base text-center leading-[1] w-44 p-4">
												Apply Here
											</a>
										</Link>
									</div>
								...
								<div className='flex justify-start bg-black bg-opacity-70 text-white text-left absolute top-0 right-0 bottom-0 left-0 p-5'>
									<div className='flex flex-col gap-4 justify-end max-w-[250px] '>
										...
										<Link href='https://bit.ly/ehcdesigners'>
											<a target='_blank' className="inline-block bg-[#0156BB] text-white text-base text-center leading-[1] w-44 p-4">
												Apply Here
											</a>
										</Link>
									</div>
